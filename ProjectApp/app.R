    ...
    fluidRow(
      column(12, 
             tags$div(
               ...
               tags$h3("Price vs. Developer Size"),
               tags$p("At first glance, we were interested in any possible relationship between price and developer size. However, 
                    a clear relationship is not apparent. It is interesting to note that there are relatively few large developers 
                    (measured by the number of Steam games published), which may warrant further investigation. It might be worthwhile 
                    to look at large developers and small developers separately."),
