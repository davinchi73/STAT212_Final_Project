...
# IGDB popularity
adv_plot <- makPtoGPlot("Price", "Popularity", "Adventure", "Adventure", "igdb_popularity", steamDataGenres)
cas_plot <- makPtoGPlot("Price", "Popularity", "Casual", "Casual", "igdb_popularity", steamDataGenres)
act_plot <- makPtoGPlot("Price", "Popularity", "Action", "Action", "igdb_popularity", steamDataGenres)
rac_plot <- makPtoGPlot("Price", "Popularity", "Racing", "Racing",  "igdb_popularity",steamDataGenres)
ind_plot <- makPtoGPlot("Price", "Popularity", "Indie", "Indie",  "igdb_popularity",steamDataGenres)
RPG_plot <- makPtoGPlot("Price", "Popularity", "RPG", "RPG",  "igdb_popularity",steamDataGenres)
sim_plot <- makPtoGPlot("Price", "Popularity", "Simulation", "Simulation", "igdb_popularity", steamDataGenres)
