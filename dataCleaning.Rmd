...
makPtoGPlot <- function(xlab, ylab, title, genreVar, data) {
  cleanData <- data %>% 
    select(full_price, !!sym(genreVar), igdb_popularity) %>%
    filter(!is.na(!!sym(genreVar)), full_price <= 70, igdb_popularity <= 250)
...
adv_plot <- makPtoGPlot("Price", "Popularity", "Adventure Games, Price to Popularity", "Adventure", steamDataGenres)
cas_plot <- makPtoGPlot("Price", "Popularity", "Casual Games, Price to Popularity", "Casual", steamDataGenres)
act_plot <- makPtoGPlot("Price", "Popularity", "Action Games, Price to Popularity", "Action", steamDataGenres)
rac_plot <- makPtoGPlot("Price", "Popularity", "Racing Games, Price to Popularity", "Racing", steamDataGenres)
ind_plot <- makPtoGPlot("Price", "Popularity", "Indie Games, Price to Popularity", "Indie", steamDataGenres)
RPG_plot <- makPtoGPlot("Price", "Popularity", "RPG Games, Price to Popularity", "RPG", steamDataGenres)
sim_plot <- makPtoGPlot("Price", "Popularity", "Simulation Games, Price to Popularity", "Simulation", steamDataGenres)
...
ggarrange(adv_plot, cas_plot, act_plot, rac_plot, ind_plot, RPG_plot, sim_plot, 
          ...
          title = "Price to Popularity by Genre")
```
