...
makPtoGPlot("Price", "Popularity", "Adventure Games, Price to Popularity", "Adventure", steamDataWide)
makPtoGPlot("Price", "Popularity", "Casual Games, Price to Popularity", "Casual", steamDataWide)
makPtoGPlot("Price", "Popularity", "Action Games, Price to Popularity", "Action", steamDataWide)
makPtoGPlot("Price", "Popularity", "Racing Games, Price to Popularity", "Racing", steamDataWide)
makPtoGPlot("Price", "Popularity", "Indie Games, Price to Popularity", "Indie", steamDataWide)
makPtoGPlot("Price", "Popularity", "RPG Games, Price to Popularity", "RPG", steamDataWide)
makPtoGPlot("Price", "Popularity", "Simulation Games, Price to Popularity", "Simulation", steamDataWide)
```
